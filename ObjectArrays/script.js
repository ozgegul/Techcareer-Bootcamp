...
const productsNum = products.filter(
  (products) => products.unitPrice > 30 && products.unitPrice < 100
);

console.log(productsNum.length);

//ismi a harfi ile başlayan ürünleri console a yazdır

const productsStartA = products.filter(
  (products) => products.name.charAt(0) === "A"
);

console.log(productsStartA);

//ismi a harfi ile BİTEN ürünleri console a yazdır

const productsEndA = products.filter(
  (products) => products.name.charAt(products.name.length - 1) === "a"
);

console.log(productsEndA);

// id si 10 olan ürünün adını console a yazdır

const productsID10 = products.find((products) => products.id === 10);

console.log(productsID10.name);

//discontinued false olan kaç ürün var

const discontinuedFalse = products.filter((products) => !products.discontinued);

console.log(discontinuedFalse.length);
...
for (let i = 1; i < products.length; i++) {
  if (products[i].unitPrice < cheapestProduct.unitPrice) {
